...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "winner_names", postgresql.ARRAY(sa.String(length=255)), nullable=False
        ),
        sa.Column(
            "other_bidders", postgresql.ARRAY(sa.String(length=255)), nullable=True
        ),
        sa.Column(
            "created_at",
        ...
        sa.ForeignKeyConstraint(
            ["tender_ref"], ["tenders.tender_ref"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(op.f("ix_awards_id"), "awards", ["id"], unique=False)
    op.create_index(
        op.f("ix_awards_tender_ref"), "awards", ["tender_ref"], unique=False
    )
