...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_tenders_deadline_date'), 'tenders', ['deadline_date'], unique=False)
    op.create_index(op.f('ix_tenders_buyer_country'), 'tenders', ['buyer_country'], unique=False)
    op.create_index('ix_tenders_cpv_codes', 'tenders', ['cpv_codes'], unique=False, postgresql_using='gin')
    op.create_index('ix_tenders_publication_date_desc', 'tenders', ['publication_date'], unique=False, postgresql_using='btree')
    op.create_index('ix_tenders_deadline_date_desc', 'tenders', ['deadline_date'], unique=False, postgresql_using='btree')
    op.create_index('ix_tenders_buyer_country', 'tenders', ['buyer_country'], unique=False, postgresql_using='btree')
