...
from app.services.email import EmailService, MockEmailProvider, ResendEmailProvider
from app.db.models import SavedFilter, User, EmailLog, NotifyFrequency, TenderSource
from app.db.schemas import SavedFilterCreate, EmailLogCreate
...
class TestEmailService:
    ...
    def test_email_service_format_cpv_codes(self):
        ...
        assert service._format_cpv_codes(["48000000", "72000000"], 3) == "48000000, 72000000"
        assert service._format_cpv_codes(["48000000", "72000000", "45000000", "50000000"], 2) == "48000000, 72000000 (+2 more)"
...
class TestAlertService:
    ...
    async def test_find_matching_tenders_keywords(self, test_db, sample_tenders):
        ...
        matching_tenders = await alert_service._find_matching_tenders(test_db, saved_filter)
    ...
    @pytest.mark.asyncio
    async def test_process_filter_with_matching_tenders(self, test_db, sample_user, sample_tenders):
    ...
    async def test_send_alerts_for_filter(self, test_db, sample_user, sample_tenders):
        ...
        with patch('app.services.alerts.email_service') as mock_email_service:
            ...
            result = await alert_service.send_alerts_for_filter(test_db, str(saved_filter.id))
