...
class TestCPVMapper:
    ...
    def test_get_cpv_hierarchy(self):
        ...
        assert any(item["code"] == "48000000" for item in hierarchy)  # Parent categories
...
class TestTenderDeduplicator:
    ...
    def test_text_similarity(self):
        ...
        # Identical texts
        assert dedup._text_similarity("Software Development", "Software Development") == 1.0
        
        # Similar texts
        similarity = dedup._text_similarity("Software Development", "Software Development Services")
    ...
    def test_cpv_similarity(self):
        ...
        similarity = dedup._cpv_similarity(["48000000", "72000000"], ["48000000", "45000000"])
    ...
    def test_group_by_fingerprint(self):
        ...
        assert any(len(group) == 2 for group in groups.values())  # One group has 2 items
    ...
    def test_deduplicate_tenders(self):
        ...
        assert any(t["tender_ref"] == "TEST-003" for t in deduplicated)  # Unique tender kept
...
class TestIngestService:
    ...
    async def test_run_ingest_success(self, test_db):
        ...
        with patch('app.services.ingest.fetch_last_tenders') as mock_ted, \
    ...
    async def test_run_ingest_scraper_error(self, test_db):
        ...
        with patch('app.services.ingest.fetch_last_tenders') as mock_ted, \
            ...
            assert results["errors"] == 0  # Errors are logged but not counted in results
