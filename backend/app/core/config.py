...
class ScrapingSettings(BaseSettings):
    ...
    ted_dataset_id: str = Field(
        default="ted-csv",
        description="TED dataset ID"
    )
    boamp_base_url: str = Field(
        default="https://www.boamp.fr",
        description="BOAMP base URL"
    )
...
class Settings(BaseSettings):
    ...
    # Scheduler
    scheduler_timezone: str = Field(default="Europe/Paris", description="Scheduler timezone")
    ingest_interval_hours: int = Field(default=6, description="Ingest interval in hours")
