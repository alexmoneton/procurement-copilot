...
class TenderDeduplicator:
    ...
    def find_duplicates(
        self, tenders: List[Dict], similarity_threshold: float = 0.8
    ...
    def _value_similarity(
        self, value1: Optional[float], value2: Optional[float]
    ) -> float:
