    ...
    def __init__(self):
        self.pricing_tiers = {
            ...
            'pro': {
                ...
                'countries': 5,
                'features': ['all_starter', 'response_templates', 'compliance_checklists', 'competitor_analysis']
            },
            'expert': {
                'price': 399,
                'opportunities_per_week': 'unlimited',
                'countries': 'unlimited',
                'features': ['all_pro', 'win_probability', 'custom_integrations', 'priority_support']
            }
        }
...
class PremiumEmailGenerator:
    ...
    def generate_premium_alert(self, opportunities: List[Dict], user_profile: Dict, user_name: str = "") -> Dict:
        ...
        for opp in opportunities:
            opp['smart_score'] = self.intelligence.calculate_smart_score(opp, user_profile)
        
        # Sort by intelligence score
        top_opportunities = sorted(opportunities, key=lambda x: x.get('smart_score', 0), reverse=True)[:3]
    ...
    def generate_subject_line(self, opportunities: List[Dict], user_profile: Dict) -> str:
